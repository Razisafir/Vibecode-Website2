    ...
    <div className="py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white">Download VibeCode</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {PLATFORMS.map((item) => (
            <div
              key={item.platform}
              className="rounded-xl border border-white/5 bg-[#12121a] p-6 text-center hover:border-emerald-500/20 transition-all flex flex-col"
            >
              <item.icon className="h-12 w-12 text-emerald-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-white">{item.platform}</h3>
              <p className="text-sm text-gray-400 mt-1">{item.version}</p>
              ...
              <a
                href={item.directUrl}
                className="mt-5 inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-black hover:bg-emerald-400 transition-colors"
              >
                <Download className="h-4 w-4" />
                Download .{item.ext}
              </a>
              ...
              <div className="mt-5 text-left flex-1">
                <p className="text-xs font-medium uppercase text-gray-500 tracking-wide mb-2">
                  Install Steps
                </p>
        ...
        <div className="mt-12 max-w-3xl mx-auto">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-500 mb-4 text-center">
            Alternative Downloads
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {ALT_DOWNLOADS.map((alt) => (
              <a
                key={alt.label}
                href={alt.url}
                className="flex items-center gap-2 rounded-lg border border-white/5 bg-[#12121a] px-4 py-3 text-sm text-gray-300 hover:border-emerald-500/20 hover:text-white transition-all"
              >
        ...
        {/* Important notes */}
        <div className="mt-12 text-center text-sm text-gray-400 max-w-2xl mx-auto space-y-4">
          <div className="rounded-lg border border-white/5 bg-[#12121a] p-5 text-left">
            <p className="font-semibold text-white mb-3">Important Notes</p>
            <ul className="space-y-3">
              <li>
                <strong className="text-white">Windows SmartScreen:</strong> The app is not code-signed yet. You will see a
                &quot;Windows protected your PC&quot; warning. Click <strong>&quot;More info&quot;</strong> then{" "}
                <strong>&quot;Run anyway&quot;</strong> to proceed. This is safe.
              </li>
              <li>
                <strong className="text-white">macOS Gatekeeper:</strong> Right-click the app and select <strong>&quot;Open&quot;</strong>{" "}
                the first time. If blocked, go to <strong>System Settings → Privacy &amp; Security</strong> and
                click <strong>&quot;Open Anyway&quot;</strong>.
              </li>
              <li>
                <strong className="text-white">Auto-updates:</strong> VibeCode will automatically check for updates on launch.
                New versions are downloaded and installed in the background.
              </li>
              <li>
                <strong className="text-white">vibecode:// protocol:</strong> The installer registers the <code className="rounded bg-[#0a0a0f] px-1.5 py-0.5 text-xs text-emerald-400">vibecode://</code> URL
                protocol for deep linking from browsers and other apps.
              </li>
              <li>
                <strong className="text-white">Extensions:</strong> VibeCode uses the Open VSX marketplace for extensions. Most VS Code
        ...
        <div className="mt-8 text-center">
          <a
            ...
            className="text-sm text-emerald-400 hover:text-emerald-300 inline-flex items-center gap-1 transition-colors"
          >
